  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#000', color: '#fff' }}>
      <div className="max-w-md w-full text-center flex flex-col gap-6">
        ...
        <div className="rounded-2xl p-4 text-left text-sm" style={{ background: '#16181C', border: '1px solid #2F3336' }}>
          <p className="font-mono" style={{ color: '#8899A6' }}>错误代码：LICENSE_DOMAIN_NOT_ALLOWED</p>
          <p className="font-mono mt-1" style={{ color: '#8899A6' }}>主题来源：<a href="https://github.com/mofajiang/project-x" className="underline" style={{ color: '#1D9BF0' }}>mofajiang/project-x</a></p>
        </div>
        <a
