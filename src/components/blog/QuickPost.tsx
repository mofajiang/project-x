...
export function QuickPost({ avatar, username }: Props) {
  ...
  return (
    <div className="flex gap-3 border-b px-4 py-3" style={{ borderColor: 'var(--border)' }}>
      {/* 头像 */}
      <div
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-full px-4 py-1 text-sm font-bold text-white transition-opacity hover:opacity-90 disabled:opacity-50"
